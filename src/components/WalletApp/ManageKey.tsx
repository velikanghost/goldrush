...
const ManageKey = () => {
  ...
  return (
    <div className="flex flex-col justify-center h-[75%] px-6">
      {decryptState === true && walletPrivateKey !== '' ? (
        <div>
          <h2 className="mt-8 mb-4 text-lg font-semibold">Your Private Key</h2>
          <p className="px-3 py-5 mb-8 font-medium text-left text-red-600 border border-red-600 rounded">
            Do not share this private key. <br /> Anyone with your private key
            will have full control of your wallet.
          </p>
...
export default observer(ManageKey)
